...
public class PickupTruck extends Vehicle {
    ...
    public PickupTruck(long carID, String vehicleType, String subType, int speed, double fuel, int seats, int year, String drivetrain, int price, int quantity, String cargoBeds, int cargoCapacity) {
